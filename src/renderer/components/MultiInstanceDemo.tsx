    ...
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      >
        ...
        <ul style={{ margin: 0, paddingLeft: '20px', color: '#64748b', lineHeight: '1.6' }}>
          <li>
            <strong>独立实例:</strong> 每个计数器调用useMVVM创建独立的C++实例
          </li>
          <li>
            <strong>实例管理:</strong> 主进程维护Map&lt;instanceId, ViewModel&gt;映射
          </li>
          <li>
            <strong>事件隔离:</strong> 属性变化事件通过instanceId进行路由
          </li>
          <li>
            <strong>内存管理:</strong> 组件卸载时自动清理对应的C++实例
          </li>
          <li>
            <strong>并发安全:</strong> 多实例并发操作互不影响
          </li>
        </ul>
      </div>
    </div>
